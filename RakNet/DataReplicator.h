...
public:
	...
	/// \note Clients (IsNetworkIDAuthority()==false) cannot update memory they own if they do not also own the object.
	/// \note Servers (IsNetworkIDAuthority()==true) can always update memory, even if they do not own that memory.

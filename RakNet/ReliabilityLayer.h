...
// You should define this for your release builds to decrease the code size
// #define _FINAL
...
private:
	...
	InternalPacket* CreateInternalPacketFromBitStream( RakNet::BitStream *bitStream, RakNetTime time );
	...
	void InsertIntoSplitPacketList( InternalPacket * internalPacket, RakNetTime time );
	...
	InternalPacket * BuildPacketFromSplitPacketList( SplitPacketIdType splitPacketId, RakNetTime time );
	...
	InternalPacket * CreateInternalPacketCopy( InternalPacket *original, int dataByteOffset, int dataByteLength, RakNetTime time );
	...
	// outputQueue_MUTEX,// We don't have to mutex this as long as Receive and HandleSocketReceiveFromConnectedPlayer are called by the same thread
	messageNumber_MUTEX,
	...
	*/
	...
	DataStructures::Queue<InternalPacket*> acknowledgementQueue, outputQueue;
...
/*
	...
	*/
	...
	RakNetTime lastPacketLossTime, lastWindowDropTime;
	...
	// Internet simulator
	unsigned short maxPacketsOnWire, minExtraPing, extraPingVariance;
#endif

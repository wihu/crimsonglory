...
enum gmCodeTreeNodeType { CTNT_INVALID = 0, CTNT_DECLARATION, CTNT_STATEMENT, CTNT_EXPRESSION, };
...
enum gmCodeTreeNodeDeclarationType { CTNDT_PARAMETER = 0, CTNDT_VARIABLE, };



/// \enum gmCodeTreeVariableType
/// \brief if a treenode is CTNT_DECLARATION, CTNDT_VARIABLE, this is the type of variable decl.
enum gmCodeTreeVariableType { CTVT_LOCAL = 0, CTVT_GLOBAL, CTVT_MEMBER, };
...
enum gmCodeTreeNodeStatementType { CTNST_INVALID = 0, CTNST_RETURN, CTNST_BREAK, CTNST_CONTINUE, CTNST_FOR, CTNST_FOREACH,
                                   CTNST_WHILE, CTNST_DOWHILE, CTNST_IF, CTNST_COMPOUND, };



/// \enum gmCodeTreeNodeExpressionType
/// \brief
enum gmCodeTreeNodeExpressionType { CTNET_INVALID = 0, CTNET_OPERATION, CTNET_CONSTANT, CTNET_IDENTIFIER, CTNET_THIS,
                                    CTNET_CALL, CTNET_FUNCTION, CTNET_TABLE, };



/// \enum gmCodeTreeNodeOperationType
/// \brief
enum gmCodeTreeNodeOperationType { CTNOT_INVALID = 0, CTNOT_DOT, CTNOT_UNARY_PLUS, CTNOT_UNARY_MINUS,
                                   CTNOT_UNARY_COMPLEMENT, CTNOT_UNARY_NOT, CTNOT_ARRAY_INDEX, CTNOT_TIMES, CTNOT_DIVIDE,
                                   CTNOT_REM, CTNOT_ADD, CTNOT_MINUS, CTNOT_LT, CTNOT_GT, CTNOT_LTE, CTNOT_GTE, CTNOT_EQ,
                                   CTNOT_NEQ, CTNOT_AND, CTNOT_OR, CTNOT_BIT_OR, CTNOT_BIT_XOR, CTNOT_BIT_AND,
                                   CTNOT_SHIFT_LEFT, CTNOT_SHIFT_RIGHT, CTNOT_ASSIGN, CTNOT_ASSIGN_FIELD, CTNOT_MAX, };



/// \enum gmCodeTreeNodeConstantType
enum gmCodeTreeNodeConstantType { CTNCT_INVALID = 0, CTNCT_INT, CTNCT_FLOAT, CTNCT_STRING, CTNCT_NULL, };
...
{
    // flags
    enum { CTN_POP = ( 1 << 0 ), CTN_MEMBER = ( 1 << 1 ), };

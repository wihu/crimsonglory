...
class gmMemFixed
{
  public:
    ...
    /// \brief Presize
    inline void Presize( int a_kbytes )
    {
        m_memChain.Presize( a_kbytes );
    }
    ...
    {
        return m_memChain.GetSystemMemUsed();
    }
...
gmMemFixed::gmMemFixed( unsigned int a_elementSize, unsigned int a_growSize ) : m_memChain( a_elementSize, a_growSize )
{

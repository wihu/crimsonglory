...
void gmMemFixedSet::Presize( int a_pool8, int a_pool16, int a_pool24, int a_pool32, int a_pool64, int a_pool128, int a_pool256, int a_pool512 )
{
    if ( a_pool8 )
    {
      m_mem8.Presize( a_pool8 );
    }
    if ( a_pool16 )
    {
      m_mem16.Presize( a_pool16 );
    }
    if ( a_pool24 )
    {
      m_mem24.Presize( a_pool24 );
    }
    if ( a_pool32 )
    {
      m_mem32.Presize( a_pool32 );
    }
    if ( a_pool64 )
    {
      m_mem64.Presize( a_pool64 );
    }
    if ( a_pool128 )
    {
      m_mem128.Presize( a_pool128 );
    }
    if ( a_pool256 )
    {
      m_mem256.Presize( a_pool256 );
    }
    if ( a_pool512 )
    {
      m_mem512.Presize( a_pool512 );
    }
}

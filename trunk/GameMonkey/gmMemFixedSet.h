...
class gmMemFixedSet
{
  public:
    ...
    inline unsigned int GetMemUsed() const
    {
        return m_memUsed;
    }
  ...
  protected:
    ...
    inline SmallMemNode* GetSmallNodeData( void* a_ptr )
    {
        return ( ( SmallMemNode * ) a_ptr ) - 1;
    }
    inline BigMemNode* GetBigNodeData( void* a_ptr )
    {
        return ( ( BigMemNode * ) a_ptr ) - 1;
    }
...
gmMemFixedSet::gmMemFixedSet() : m_mem8( 8 + sizeof( SmallMemNode ), 64 ), m_mem16( 16 + sizeof( SmallMemNode ), 64 ),
                                 m_mem24( 24 + sizeof( SmallMemNode ), 64 ), m_mem32( 32 + sizeof( SmallMemNode ), 64 ),
                                 m_mem64( 64 + sizeof( SmallMemNode ), 32 ), m_mem128( 128 + sizeof( SmallMemNode ), 32 ),
                                 m_mem256( 256 + sizeof( SmallMemNode ), 16 ), m_mem512( 512 + sizeof( SmallMemNode ), 16 )
{
    m_memUsed = 0;
}

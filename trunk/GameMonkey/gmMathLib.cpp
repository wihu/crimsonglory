...
static int GM_CDECL gmfDegToRad( gmThread* a_thread )
{
    ...
    if ( a_thread->ParamType( 0 ) == GM_INT )
    {
      floatValue = ( float )a_thread->Param( 0 ).m_value.m_int;
    }
    else if ( a_thread->ParamType( 0 ) == GM_FLOAT )
    {
      floatValue = a_thread->Param( 0 ).m_value.m_float;
    }
    else
    {
      return GM_EXCEPTION;
...
static int GM_CDECL gmfATan2( gmThread* a_thread )
{
    ...
    if ( a_thread->ParamType( 0 ) == GM_INT )
    {
      floatValueY = ( float )a_thread->Param( 0 ).m_value.m_int;
    }
    else if ( a_thread->ParamType( 0 ) == GM_FLOAT )
    {
      floatValueY = a_thread->Param( 0 ).m_value.m_float;
    }
    else
    {
      return GM_EXCEPTION;
    ...
    {
      floatValueX = ( float )a_thread->Param( 0 ).m_value.m_int;
    }
    else if ( a_thread->ParamType( 1 ) == GM_FLOAT )
    {
      floatValueX = a_thread->Param( 0 ).m_value.m_float;
    }
    else
    {
      return GM_EXCEPTION;
...
{
  {"String", gmfToString}, {"Float", gmfToFloat}, {"Int", gmfToInt},
};

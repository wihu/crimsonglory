...
#ifndef __C_DMF_LOADER2_H_INCLUDED__
#define __C_DMF_LOADER2_H_INCLUDED__
    ...
    namespace scene
    {
        ...
        class CDMFLoader : public IMeshLoader
        {
          public:
            ...
            virtual IAnimatedMesh* createMesh( irr::io::IReadFile* file, irr::core::vector3d<f32> vScale );
            ...
            int loadLights( const c8* filename, irr::scene::ISceneManager* smgr, ISceneNode* parent = 0, s32 base_id = 1000 );
            ...
            int loadWaterPlains( const c8* filename, irr::scene::ISceneManager* smgr, ISceneNode* parent = 0, s32 base_id = 2000, bool mode = true );

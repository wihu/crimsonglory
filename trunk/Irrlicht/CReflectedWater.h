...
class CReflectedWater : public video::IShaderConstantSetCallBack
{
  public: 
    //! constructor 
    CReflectedWater( const irr::c8* name, IrrlichtDevice* device, scene::ISceneManager* smgr, s32 id, f32 tileSize, s32 tileCount, core::dimension2d<s32> RenderTargetSize ); 

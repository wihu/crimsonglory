...
class DistributedNetworkObject : public NetworkObject
{
  public:
     ...
     */
    void SynchronizeMemory( unsigned char memoryBlockIndex, char* memoryBlock, unsigned short memoryBlockSize,
     ...
     */
    virtual void SerializeClassHeader( RakNet::BitStream* bitStream, char* classIdentifier, int action, bool localObject,
     ...
     * action of 0 means destruction, 1 means update, 2 means create
     */
    static bool DeserializeClassHeader( RakNet::BitStream* bitStream, int& action, ObjectID& objectId,
                                        char classIdentifier[MAXIMUM_CLASS_IDENTIFIER_LENGTH], bool& localObject,
                                        unsigned char& localObjectIndex, PlayerID& pid );
    /**
     * You don't need to modify this
     ...
     */
    virtual bool ProcessDistributedMemoryStack( RakNet::BitStream* bitStream, bool isWrite, bool forceWrite,

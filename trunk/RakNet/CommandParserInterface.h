...
public:
	...
	virtual bool GetRegisteredCommand(const char *command, CommandParserInterface::RegisteredCommand *rc);
...
protected:
	...
	static int RegisteredCommandComp( const char* const & key, const CommandParserInterface::RegisteredCommand &data );
	DataStructures::OrderedList<const char*, RegisteredCommand, CommandParserInterface::RegisteredCommandComp> commandList;
};

...
const irr::c8 WATER_VERTEX_GLSL[] = "uniform float Time; \n"
...
"}\n";
const irr::c8 WATER_FRAGMENT_GLSL[] = "uniform sampler2D ReflectionTexture;  \n"
...
"} \n";
const irr::c8 WATER_HLSL[] = "uniform float Time; \n" 
...
"   return Output; \n"
"}\n";
const irr::c8 CLAMP_VERTEX_GLSL[] = "varying float cutoff;\n" 
"void main()\n" 
"{\n" 
"   cutoff = gl_Vertex.y;\n" 
"   gl_Position = ftransform();\n" 
...
"}\n"; 
const irr::c8 CLAMP_FRAGMENT_GLSL[] = "uniform sampler2D DiffuseMap, DetailMap;\n" 
...
const irr::c8 CLAMP_HLSL[] = "uniform float Time;\n" 
"float4x4 mWorldViewProj;\n" 

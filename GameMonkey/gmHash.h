...
class gmHash
{
  public:
    ...
    class Iterator
    {
      public:
        ...
        inline T* Resolve( void )
        {
            return m_elem;
        }
        inline const T* Resolve( void ) const
        {
            return m_elem;
        }
  ...
  private:
    ...
    T* GetNext( T* a_elem ) const
    {
        return a_elem->NQUAL::m_next;
    }
    T** m_table;
    gmuint m_count;
    gmuint m_size;
...
TMPL QUAL::gmHash( gmuint a_size )
{

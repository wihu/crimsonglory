...
class gmStreamBufferDynamic : public gmStream
{
  public:
    ...
    inline void SetBlockSize( unsigned int a_blockSize )
    {
        m_stream.SetBlockSize( a_blockSize );
    }
    inline const char* GetData() const
    {
        return m_stream.GetData();
    }
    inline char* GetUnsafeData()
    {
        return m_stream.GetData();
    }
    void SetSize( unsigned int a_size )
    {
        m_stream.SetCount( a_size );
    }
    void SetCursor( unsigned int a_cursor )
    {
        m_cursor = a_cursor;
    }

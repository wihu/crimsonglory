...
enum gmCFunctionReturn { GM_OK = 0, GM_EXCEPTION = -1, GM_SYS_YIELD = -2, // system only
...
class gmFunctionObject : public gmObject
{
  public:
    ...
    */
    ...
    inline int GetNumParamsLocals() const
    {
        return m_numParamsLocals;
    }
    ...
    int GetLine( const void* a_instruction ) const
    {
        return GetLine( ( const char * ) a_instruction - ( char * ) m_byteCode );
    }

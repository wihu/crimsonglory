...
{
    if ( _gmstricmp( a_operatorName, "getdot" ) == 0 )
    {
      return O_GETDOT;
    }
    if ( _gmstricmp( a_operatorName, "getdot" ) == 0 )
    ...
    if ( _gmstricmp( a_operatorName, "getind" ) == 0 )
    {
      return O_GETIND;
    }
    if ( _gmstricmp( a_operatorName, "setind" ) == 0 )
    {
      return O_SETIND;
    }
    if ( _gmstricmp( a_operatorName, "add" ) == 0 )
    {
      return O_ADD;
    }
    if ( _gmstricmp( a_operatorName, "sub" ) == 0 )
    {
      return O_SUB;
    }
    if ( _gmstricmp( a_operatorName, "mul" ) == 0 )
    {
      return O_MUL;
    }
    if ( _gmstricmp( a_operatorName, "div" ) == 0 )
    {
      return O_DIV;
    }
    if ( _gmstricmp( a_operatorName, "mod" ) == 0 )
    {
      return O_REM;
    }
    if ( _gmstricmp( a_operatorName, "bitor" ) == 0 )
    {
      return O_BIT_OR;
    }
    if ( _gmstricmp( a_operatorName, "bitxor" ) == 0 )
    {
      return O_BIT_XOR;
    }
    if ( _gmstricmp( a_operatorName, "bitand" ) == 0 )
    {
      return O_BIT_AND;
    }
    if ( _gmstricmp( a_operatorName, "shiftleft" ) == 0 )
    {
      return O_BIT_SHIFTLEFT;
    }
    if ( _gmstricmp( a_operatorName, "shiftright" ) == 0 )
    {
      return O_BIT_SHIFTRIGHT;
    }
    if ( _gmstricmp( a_operatorName, "bitinv" ) == 0 )
    {
      return O_BIT_INV;
    }
    if ( _gmstricmp( a_operatorName, "lt" ) == 0 )
    {
      return O_LT;
    }
    if ( _gmstricmp( a_operatorName, "gt" ) == 0 )
    {
      return O_GT;
    }
    if ( _gmstricmp( a_operatorName, "lte" ) == 0 )
    {
      return O_LTE;
    }
    if ( _gmstricmp( a_operatorName, "gte" ) == 0 )
    {
      return O_GTE;
    }
    if ( _gmstricmp( a_operatorName, "eq" ) == 0 )
    {
      return O_EQ;
    }
    if ( _gmstricmp( a_operatorName, "neq" ) == 0 )
    {
      return O_NEQ;
    }
    if ( _gmstricmp( a_operatorName, "neg" ) == 0 )
    {
      return O_NEG;
    }
    if ( _gmstricmp( a_operatorName, "pos" ) == 0 )
    {
      return O_POS;
    }
    if ( _gmstricmp( a_operatorName, "not" ) == 0 )
    {
      return O_NOT;
    }
